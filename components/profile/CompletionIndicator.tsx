    ...
    <Card className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
      <div className="flex-1 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Badge variant="error">PHONE</Badge>
          <Badge variant="error">LOCATION</Badge>
          <Badge variant="error">EDUCATION</Badge>
        </div>
      </div>
      ...
      <div className="relative flex items-center justify-center w-24 h-24 shrink-0">
        ...
        <div className="absolute flex items-center justify-center inset-0">
          <span className="text-xl font-bold text-text-darkest">{completionPercentage}%</span>
        </div>
      </div>
    </Card>
  )
